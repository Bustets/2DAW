...
if ($method == 'GET') {
  ...
  $alumno1 = new stdClass();
    ...
    $alumno1->direccion = "Calle val paraiso";
    $alumno1->pwd = "33333";
    ...
    $alumno2->ciclo = "1DAM";
    $alumno2->direccion = "Calle val paraiso";
    $alumno2->pwd = "33333";

    $alumno3 = new stdClass();
    $alumno3->nombre = "OTRO";
    $alumno3->dniCliente = "55645646g";
    ...
    $alumno3->ciclo = "1ASIR";
    $alumno3->direccion = "Calle val paraiso";
    $alumno3->pwd = "33333";
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'DELETE'){ // metodo delete para borrar
    $dniAlumno = $_GET['dniAlumno'];  // para el dniCliente a borrar
